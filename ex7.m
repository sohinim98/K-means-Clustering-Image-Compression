...
%  To help ourselves implement K-Means, we have divided the learning algorithm 
%  into two functions -- findClosestCentroids and computeCentroids. In this
%  part, we should complete the code in the findClosestCentroids function. 
%
...
%  After implementing the closest centroids function, we should now
...
% but in practice we want to generate them automatically, such as by
...
%  
%  We should now complete the code in kMeansInitCentroids.m
%
...
% If imread does not work for us, we can try instead
%   load ('bird_small.mat');
...
% randomly. 
% We should complete the code in kMeansInitCentroids.m before proceeding
